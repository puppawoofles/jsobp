class UnitSelect {
    ...
    static setup(me, params) {
        ...
        var optionHolder = qs(me, ".option_holder");
    ...
    static Accept(event, handler) {
        var holder = qs(handler, ".selected_holder");
    ...
    static OnSelected(event, handler) {
        ...
        if (Card.Selected.get(card)) {
            ...
            destination = qs(handler, ".selected_holder");
        } else {
            // Move it into the option holder.
            destination = qs(handler, ".option_holder");
        }
    ...
    static refreshAcceptButton(handler) {
        var selectedHolder = qs(handler, ".selected_holder");
    ...
    static OnHover(event, handler) {
        ...
        var preview = qs(handler, ".unit_preview");
